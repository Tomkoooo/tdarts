...
async function __GET(request: NextRequest) {
  try {
    ...
    const dailyStats = await ClubModel.aggregate([
      {
        $match: {
    ...
    console.error('Error fetching daily club stats:', error);
    return NextResponse.json(
...
export const GET = withApiTelemetry('/api/admin/charts/clubs/daily', __GET as any);
