      ...
      datasets.push(
        {
          ...
          data: series.map(() => Math.round(allTimeAvgRequestKb * 100) / 100),
          backgroundColor: 'rgba(107, 114, 128, 0.05)',
          borderColor: 'rgb(107, 114, 128)',
        },
        {
          label: 'All-time avg outgoing (KB)',
          data: series.map(() => Math.round(allTimeAvgResponseKb * 100) / 100),
          backgroundColor: 'rgba(107, 114, 128, 0.05)',
          borderColor: 'rgb(99, 102, 241)',
        },
        {
          label: 'All-time avg total (KB)',
          data: series.map(() => Math.round(allTimeAvgTotalKb * 100) / 100),
          backgroundColor: 'rgba(107, 114, 128, 0.05)',
