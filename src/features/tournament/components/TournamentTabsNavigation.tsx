...
export function TournamentTabsNavigation({
  ...
  return (
    <div className="sticky top-2 z-30 rounded-2xl border border-border/60 bg-card/92 p-2.5 shadow-[0_10px_28px_rgba(0,0,0,0.28)] backdrop-blur-xl md:top-3 md:p-2">
      <div className="relative">
        ...
        <TabsList
          ref={tabsListRef}
          className="flex h-auto w-full gap-1.5 overflow-x-auto rounded-xl bg-transparent p-0 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
        >
          {scorerHref ? (
            <Link
              href={scorerHref}
