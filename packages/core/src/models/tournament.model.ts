...
import type { TournamentDocument } from '../interfaces/tournament.interface';
import './club.model';
import './player.model';
import './match.model';
...
const tournamentSchema = new mongoose.Schema<TournamentDocument>({
    ...
    tournamentSettings: {
        ...
        maxDartsPerLeg: { type: Number, default: null },
        groupAdvancesToKnockout: { type: Number, default: null },
    },
