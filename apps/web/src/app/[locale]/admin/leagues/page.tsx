...
import { AdminLeaguesTable } from '@/features/admin/leagues/AdminLeaguesTable';
...
export default async function AdminLeaguesPage({
  ...
  const { total, rows } = await AdminLeaguesQueryService.list({ q, page, limit: 25 });
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {total} leagues · page {page} of {totalPages}
        </p>
      </div>
