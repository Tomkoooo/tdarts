...
export async function removeModeratorAction(input: z.infer<typeof schema>) {
  const run = withTelemetry(
    'clubs.removeModerator',
    ...
    {
      method: 'ACTION',
      metadata: { feature: 'clubs', actionName: 'removeModerator', clubId: input.clubId },
